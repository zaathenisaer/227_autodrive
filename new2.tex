...
\resizebox{\linewidth}{!}{%
\begin{tabular}{p{1.7cm} p{0.8cm} p{1.3cm} p{1.8cm} p{1.7cm} p{1.5cm} p{1.6cm} p{1.9cm} p{2.2cm}}
\toprule
...
Social LSTM~\cite{alahi2016social} & 2016 & I/II bridge & Grid-based social pooling &
...
which \\emph{problem formulation} they take seriously. DAVE-2 and ChauffeurNet
primarily treat robustness to distributional shift. QMIX, MADDPG, and MAPPO
primarily treat coordination under non-stationarity. V2VNet treats observability
itself as a distributed systems problem. DiLu and LanguageMPC treat rare-event
reasoning and semantic interpretation as first-class bottlenecks. This is why a
cross-paradigm table is especially important in a survey of this field.
