...
preserving coverage of more than 100 references. Across paradigms, three tensions recur: expressiveness versus
...
control), and \emph{mixed-autonomy traffic shaping} \cite{wei2019colight,wei2019presslight,stern2018dissipation,wu2017flow}. Keeping these deployment locations separate is crucial when comparing methods, because what counts as ``state'', ``action'', and even ``agent'' varies sharply across them.
