...
\citep{dosovitskiy17a}. The platform provides:
\begin{itemize}[noitemsep]
...
\citet{dosovitskiy17a} introduced \emph{CARLA}, an open-source urban driving simulator, which
...
\midrule
CARLA \citep{dosovitskiy17a} & Both & Limited & Rule-based &
IL/RL training \& eval \\
...
rely on cloud-hosted or GPU-accelerated foundation models. As of their respective
publication years (2023--2024), cloud API query latency for GPT-class models
...
control. Even LanguageMPC's 1--2\,Hz LLM cycle requires a stable low-latency
network connection. Edge deployment will
