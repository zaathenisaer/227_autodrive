...
\textbf{Scenario / Benchmark} & \textbf{Safety Strategy} & \textbf{Comm. Need} &
\textbf{Key Strength} & \textbf{Primary Limitation} \\
\midrule
DAVE-2 \citep{bojarski2016end} & 2016 & IL & End-to-end BC from raw pixels &
Lane keeping / real-road & Data-driven implicit cues & None &
Proof of end-to-end feasibility & Severe covariate shift \\

ChauffeurNet \citep{bansal2018chauffeur} & 2018 & IL & Perturbation-augmented imitation &
...
Social LSTM \citep{alahi2016social} & 2016 & Interaction model &
...
VectorNet \citep{gao2020vectornet} & 2020 & Interaction model &
...
PiP \citep{song2020pip} & 2020 & Interaction-planning coupling &
...
DiLu \citep{wen2023dilu} & 2023 & LLM cognitive agent &
...
increased data and compute availability, benchmark realism (open-loop to
closed-loop), and stronger deployment requirements from interaction-heavy urban
traffic. These drivers motivate why the field moved from imitation-only
pipelines to interaction-aware MARL and then toward LLM-augmented cognitive
architectures.
